...
Usage:
    ...
    modal run --detach modal_train.py::main --run-name ppo_contact_v2 --stage both --rl-variant ppo_asym_contact_gated_v2 --tactile
...
def with_rl_variant_overrides(extra_args: tuple[str, ...], rl_variant: str = RL_VARIANT_PPO) -> tuple[str, ...]:
    ...
    elif rl_variant == RL_VARIANT_PPO_CONTACT_GATED:
        append_if_missing("train.ppo.contact_event_gating", "True")
    ...
    elif rl_variant == RL_VARIANT_PPO_ASYM_CONTACT_GATED_V2:
        append_if_missing("train.ppo.asymmetric_critic", "True")
        append_if_missing("train.ppo.actor_use_privileged_info", "False")
        append_if_missing("train.ppo.contact_event_gating", "True")
        append_if_missing("train.ppo.contact_num_modes", "4")
